...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Өңдеу',
        href: `/lessons/${props.lesson.id}/edit`,
    },
];
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        <Head :title="`${props.lesson.title} - өңдеу`" />
        ...
        <div class="space-y-5 p-4 md:p-6">
            ...
            <Card class="max-w-3xl shadow-sm">
                <CardHeader>
                    ...
                    <CardDescription>Сабақ атауы таңдалған пәнге қарай автоматты түрде жаңартылады.</CardDescription>
                </CardHeader>
                <CardContent>
                    <form class="space-y-6" @submit.prevent="submit">
                        <div class="grid gap-6 md:grid-cols-2">
                            ...
                            <div class="grid gap-2 md:col-span-2">
                                <Label for="jitsi_room">Jitsi бөлмесі</Label>
                                <Input id="jitsi_room" :model-value="props.lesson.jitsi_room ?? 'Автоматты түрде жасалады'" readonly />
                                <p class="text-sm text-muted-foreground">
                                    Бұл бөлме аты сабақ бетінде Jitsi ішкі қоңырауын ашу үшін қолданылады.
                                </p>
                            </div>
                        </div>
