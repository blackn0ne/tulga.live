...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        <Head title="Сынып қосу" />

        <div class="space-y-5 p-4 md:p-6">
            <section class="rounded-2xl border bg-card p-5 shadow-sm">
                <div class="space-y-1">
                    <h1 class="text-2xl font-semibold tracking-tight">Сынып қосу</h1>
                    <p class="text-sm text-muted-foreground">Жаңа сынып құру үшін тек атауын енгізу жеткілікті.</p>
                </div>
            </section>
                ...
                <CardContent>
                    <form class="space-y-6" @submit.prevent="submit">
                        <div class="grid gap-2">
                            ...
                            <Input id="name" v-model="form.name" required autofocus placeholder="Мысалы: 10 А сыныбы" />
