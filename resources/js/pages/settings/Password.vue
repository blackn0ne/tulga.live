...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        <Head title="Құпиясөз баптаулары" />

        <SettingsLayout>
            <div class="space-y-6">
                <HeadingSmall title="Құпиясөзді жаңарту" description="Аккаунт қауіпсіз болуы үшін күрделі құпиясөз қолданыңыз" />

                <form @submit.prevent="updatePassword" class="space-y-6">
                    <div class="grid gap-2">
                        <Label for="current_password">Қазіргі құпиясөз</Label>
                        <Input
                            id="current_password"
                    ...
                    <div class="flex items-center gap-4">
                        <Button :disabled="form.processing">Құпиясөзді сақтау</Button>
