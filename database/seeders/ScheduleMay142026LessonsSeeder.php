...
class ScheduleMay142026LessonsSeeder extends Seeder
{
    private const SCHEDULE_DATE = '2026-05-14';
    ...
    /**
     * Сабақ кестесі 14.05.2026 (7–9 сынып, Word кестесінен).
    ...
    public function run(): void
    {
        ...
        $rows = require __DIR__.'/data/may142026_schedule_rows.php';
