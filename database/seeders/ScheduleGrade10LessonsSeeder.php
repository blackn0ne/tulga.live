...
class ScheduleGrade10LessonsSeeder extends Seeder
{
    /** Кесте күні (7–9 сынып seeder-інен бөлек, қақтығыссыз). */
    private const SCHEDULE_DATE = '2026-05-15';

    /** 10.htm слоттарының аяқталуы (HH:MM). */
    ...
    /**
     * 10 сынып (10-1 … 10-10) — Desktop/10.htm негізінде.
     * Қайта орындағанда: осы күнгі 10-* сынып сабақтарын жояды.
     */
    public function run(): void
    {
        ...
        $rows = require __DIR__.'/data/grade10_schedule_rows.php';
    ...
    private function resolveTeacherUser(string $displayName): User
    {
        ...
        return User::query()->firstOrCreate(
            ...
            [
                'name' => $displayName,
                'username' => $slug.'_'.substr(hash('crc32b', $displayName), 0, 6),
